        ...
        <div>
            <div className="IntroBody">
                <div className='NameParagraph'>
                    <div>Hi, I’m <span className='nameColor'>Shanawaz </span> shaik.
            ...
            <div className='about'>
                <div><Link className='aboutText' style={{ textDecoration: 'none', color: "#1C1C1E" }} to="/About?clicked=true">About</Link></div>
